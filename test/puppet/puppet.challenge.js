...
describe("[Challenge] Puppet", function () {
  ...
  it("Execution", async function () {
    ...
    const Attack8 = await ethers.getContractFactory("Attack8", deployer);
    const attack8 = await Attack8.deploy(
      lendingPool.address,
    ...
    await token
      .connect(player)
      .transfer(attack8.address, PLAYER_INITIAL_TOKEN_BALANCE);

    await attack8.attack({ value: PLAYER_INITIAL_ETH_BALANCE });
